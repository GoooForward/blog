...
* 这里可能会有人安装失败，因为国内复杂的网络环境以及众所周知的GreatWall，如果你的网络无法反复连接到npm服务器，就很可能导致安装失败，可以尝试使用国内镜像的cnpm（请自行搜索使用）。

* hexo并不是唯一的选择，也有很多其他的优秀的网页框架，例如[Hugo](https://gohugo.io/)，如果愿意折腾也可以多去比较一下其他的网页框架。
